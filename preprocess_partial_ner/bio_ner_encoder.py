...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_train', default="./data/bio_ner/bio_ner.train.ck")
    parser.add_argument('--input_testa', default="./data/bio_ner/bio_ner.dev.ck")
    parser.add_argument('--input_testb', default="./data/bio_ner/bio_ner.test.ck")
    parser.add_argument('--pre_word_emb', default="./data/bio_embedding.pk")
    parser.add_argument('--output_folder', default="./data/hqner_bio/")
    ...
    c_map = {'<s>': 0, '<unk>': 1, '< >': 2, '<\n>': 3}
    tl_map = {'Disease': 1, 'Chemical': 2, 'None': 0}
    cl_map = {'I': 0, 'O': 1}
