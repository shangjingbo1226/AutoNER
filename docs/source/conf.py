...
latex_documents = [
    (master_doc, 'autoner.tex', 'AutoNER Documentation',
     'Jingbo Shang, Liyuan Liu', 'manual'),
]
...
man_pages = [
    (master_doc, 'AutoNER', 'AutoNER Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AutoNER', 'AutoNER Documentation',
     author, 'AutoNER', 'Efficient Contextualized Representations.',
     'Miscellaneous'),
]
