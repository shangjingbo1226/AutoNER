...
def evaluate_chunking(iterator, ner_model, none_idx):
    ...
    for word_t, char_t, chunk_mask, chunk_label, type_mask, type_label, flm_t, blm_t, blm_ind in iterator:
        output = ner_model(flm_t, blm_t, blm_ind, word_t, char_t, chunk_mask)
